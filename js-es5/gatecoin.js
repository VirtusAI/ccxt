...
function (_Exchange) {
  ...
  function gatecoin() {
    ...
    return _possibleConstructorReturn(this, (gatecoin.__proto__ || _Object$getPrototypeOf(gatecoin)).apply(this, arguments));
  }

  _createClass(gatecoin, [{
    key: "describe",
    value: function describe() {
      return this.deepExtend(_get(gatecoin.prototype.__proto__ || _Object$getPrototypeOf(gatecoin.prototype), "describe", this).call(this), {
        'id': 'gatecoin',
        'name': 'Gatecoin',
        'rateLimit': 2000,
        'countries': 'HK',
        ...
        return _regeneratorRuntime.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 4:
                _context9.next = 6;
                return this.privateDeleteTradeOrdersOrderID({
                  'OrderID': id
                });
