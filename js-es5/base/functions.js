...
var setTimeout_original = setTimeout; // setTimeout can fire earlier than specified, so we need to ensure it does not happen...
...
var deepExtend = function deepExtend() {
  ...
  for (var _i = 0; _i < args.length; _i++) {
    ...
    if (arg && _typeof(arg) == 'object' && (arg.constructor === Object || !('constructor' in arg))) {
